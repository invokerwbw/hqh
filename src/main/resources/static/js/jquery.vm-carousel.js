...
(function ($, window, document, undefined) {
	...
	Plugin.prototype = {
		...
		init: function ()
		{
			...
			this.$element.find(".d-img-tit").css("width",this.item_width).show();//杜美轩新增于2018年8月9日
		...
		slide_relative_centered_infinite: function (offset)
		{
			...
			var w = $(".vmc-clone").eq(0).width(); //杜美轩新增于2018年8月9日

			var margin_left = this.infinite_initial_margin - w * offset; //杜美轩修改于2018年8月9日
			//var margin_left = this.infinite_initial_margin - this.item_width * offset; //原来这样的 
			...
			this.animate_slide(margin_left, function(e){
				...
				//that.$element.find(".d-img-tit").css("width",w).show();//杜美轩新增于2018年8月9日
				/*that.$element.next().next().find(".d-img-tit").css("display","none");*/
